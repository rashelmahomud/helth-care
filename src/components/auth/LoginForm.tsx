        ...
        <div className="w-full max-w-md">
            ...
            <div className="mb-8">
                ...
                <p className="mt-3 text-slate-500">
                    Sign in to manage your appointments and healthcare services.
                </p>
            </div>
            ...
            <form className="space-y-6">
                ...
                <button
                    type="submit"
                    className="flex w-full items-center justify-center gap-2 rounded-xl bg-cyan-600 py-4 font-semibold text-white transition duration-300 hover:bg-cyan-700 hover:shadow-lg"
                >
                    Sign In
                    <ArrowRight size={18} />
                </button>

...
import RegisterForm from "@/src/components/RegisterFrom";


export default function RegisterPage() {
    return (
        <main className="min-h-screen bg-gradient-to-br from-cyan-50 via-white to-sky-50">
            <div className="mx-auto flex min-h-screen max-w-7xl items-center justify-center px-5 py-10 dark:bg-slate-900">
                <div className="grid w-full overflow-hidden rounded-[32px] border border-slate-200 bg-white shadow-2xl lg:grid-cols-2">
                    {/* Left Banner */}
                    <AuthBanner />

                    {/* Right Form */}
                    <div className="flex items-center justify-center p-6 sm:p-10 lg:p-14 dark:bg-slate-900">
                        <RegisterForm />
                    </div>
                </div>
            </div>
